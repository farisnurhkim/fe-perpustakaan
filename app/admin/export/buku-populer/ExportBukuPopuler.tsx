...
const ExportBukuPopuler = ({ data }: { data: any }) => {
    const books = data as unknown as IBukuPopuler[];
                ...
                <table className="w-full text-sm text-left border-collapse">
                    ...
                    <thead className="bg-emerald-600 text-white">
                        <tr>
                            ...
                            <th className="border border-slate-200 p-2 w-24 font-medium">Total Dipinjam</th>
                    ...
                    <tbody>
                        {books.map((book, index: number) => (
                            <tr key={book._id} className="hover:bg-slate-50">
                                ...
                                <td className="border border-slate-200 p-2 text-slate-700">{book.genre_buku}</td>
                                <td className="border border-slate-200 p-2 text-slate-700">{book.total_dipinjam}</td>
...
export default ExportBukuPopuler